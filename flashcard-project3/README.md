# Web Development Project 3 - Study with Me

Submitted by: Gulzira Abdullah

This web app: This app allows user to allow users to enter an answer and move backwards and forwards through the list of cards.
